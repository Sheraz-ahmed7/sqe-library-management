...
| TC-013 | Search book by title | REQ-8 | Library contains a book titled `Clean Code` | 1. Search the library for `Clean Code`. | The matching book is returned in the search results. | Medium | Positive / Functional |
